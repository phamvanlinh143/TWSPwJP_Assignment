...
def visualize(machines, lst_jobs, image_name='image'):
    ...
    for item in plot_arr:
        rectangle = Rectangle((item['Start'],0),item['Finish'] - item['Start'],0.25,color=item['Color'],alpha=0.25,linewidth=2.5)
    ...
    #     cy = ry + rectangle.get_height()/2.0
        ...
        ax[machine_idx_map[item['Machine']]].annotate(item['Job'] + ' = ' + str(item['Duration']), (cx, cy), color='black', weight='bold', fontsize=9, ha='center', va='center')
